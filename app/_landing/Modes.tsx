  ...
  return (
    <section id="che-do" aria-labelledby="modes-title" className="relative scroll-mt-24 px-4 py-20 sm:px-6 lg:py-28">
      ...
      <div className="relative mx-auto max-w-[1200px]">
        <SectionHeading id="modes-title" eyebrow={t("eyebrow")} title={t("title")} />
          ...
          {MODES.map((mode) => (
            ...
            >
              <FolderShape tone={mode.tone} className="h-full" bodyClassName="flex min-h-[260px] flex-col gap-3 px-6 pb-6 pt-7">
                <h3 className="text-[20px] font-bold tracking-tight text-on-surface">{t(`items.${mode.key}.title`)}</h3>
                <p className="text-[14px] leading-relaxed text-on-surface-medium">{t(`items.${mode.key}.body`)}</p>
