    ...
    <section aria-labelledby="hero-title" className="relative px-4 pb-20 pt-16 sm:px-6 sm:pt-24 md:pb-28">
      <div className="mx-auto max-w-6xl">
        <div className="max-w-3xl">
          ...
          >
            {t("headline")} <span className="text-zinc-500">{t("headlineMuted")}</span>
          </h1>
          <p className="mt-6 max-w-2xl text-pretty text-base leading-relaxed text-zinc-400 sm:text-lg">{t("subline")}</p>
