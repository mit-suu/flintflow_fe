...
const buttonVariants = {
  ...
  primary: `landing-gradient inline-flex items-center justify-center gap-3 rounded-full py-2 pl-6 pr-2 text-[15px] font-bold text-white shadow-[0_16px_40px_rgba(106,98,196,0.4)] transition-transform hover:-translate-y-0.5 ${focusRing}`,
  /** Nút gradient gọn (header, card giá) — không có chấm mũi tên. */
  solid: `landing-gradient inline-flex items-center justify-center rounded-full px-5 py-2.5 text-[13px] font-bold text-white shadow-[0_10px_26px_rgba(106,98,196,0.35)] transition-transform hover:-translate-y-0.5 ${focusRing}`,
    ...
    <div aria-hidden="true" className={`pointer-events-none absolute ${className}`}>
      <div
        ...
        style={{
          ...
          background:
            "radial-gradient(circle at 30% 25%, #EEEDF9 0%, #D5D1F0 22%, #8E87D6 45%, #6A62C4 68%, #C9C4EC 88%, transparent 96%)",
        }}
      />
      <div
        ...
        style={{
          ...
          background: "radial-gradient(circle at 65% 30%, rgba(255,255,255,0.95), rgba(228,225,246,0.5) 35%, transparent 62%)",
        }}
      />
      <div
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, rgba(106,98,196,0.18), transparent 70%)" }}
      />
    </div>
  );
}
